...
Funcionalidade: Buscar conversa no histórico do WhatsApp
    Quero buscar uma conversa no histórico do WhatsApp - versão app mobile para Android

    Contexto:
        Dado que eu esteja logado com um número de telefone válido
        E que eu esteja na tela inicial do app WhatsApp

    Cenário: Buscando conversa com contato cadastrado e histórico de mensagens
    ...
    Cenário: Buscando conversa com contato cadastrado e sem histórico de mensagens
    ...
    Cenário: Buscando conversa com contato que não está cadastrado na agenda
